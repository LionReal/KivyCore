...
let package = Package(
    ...
    dependencies: [
    	...
    	.binaryTarget(name: "libkivy", url: "https://github.com/KivySwiftLink/KivyCore/releases/download/311.0.3/libkivy.zip", checksum: "e475deb187fedf696059627e02e9a9b0fe319aae2a7e5b7203d4b69b1ae102a4"),
    ]

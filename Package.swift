...
let package = Package(
    ...
    dependencies: [
    	...
    	.binaryTarget(name: "libkivy", url: "https://github.com/KivySwiftLink/KivyCore/releases/download/311.0.1/libkivy.zip", checksum: "83f269124ab4bdb3c8849b948e35e62034450d78077c285c975a27797ffa4ace"),
    ]
